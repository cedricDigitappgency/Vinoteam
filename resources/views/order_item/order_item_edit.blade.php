<div class="panel panel-warning">
    <div class="panel-body">
        <input type='hidden' name='order_item_id_{{$i}}' id='order_item_id_{{$i}}' value="{{ $order[$i-1]['order_item_id'] }}">
        ...
        <div class="form-group{{ $errors->has('quantity_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="quantity_{{$i}}" type="number" class="form-control" name="quantity_{{$i}}" value="{{ old('quantity_'.$i) == null ? $order[$i-1]['quantity'] : old('quantity_'.$i) }}">
          ...
          <div class="form-group{{ $errors->has('container_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="container_{{$i}}" type="text" class="form-control" name="container_{{$i}}" value="{{ old('container_'.$i) == null ? $order[$i-1]['container'] : old('container_'.$i) }}">
          ...
          <div class="form-group{{ $errors->has('price_unit_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="price_unit_{{$i}}" type="text" class="form-control" name="price_unit_{{$i}}" value="{{ old('price_unit_'.$i) == null ? $order[$i-1]['price_unit'] : old('price_unit_'.$i) }}">
        ...
        <div class="form-group{{ $errors->has('name_cru_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="name_cru_{{$i}}" type="text" class="form-control" name="name_cru_{{$i}}" value="{{ old('name_cru_'.$i) == null ? $order[$i-1]['name_cru'] : old('name_cru_'.$i) }}">
          ...
          <div class="form-group{{ $errors->has('year_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="year_{{$i}}" type="text" class="form-control" name="year_{{$i}}" value="{{ old('year_'.$i) == null ? $order[$i-1]['year'] : old('year_'.$i) }}">
          ...
          <div class="form-group{{ $errors->has('region_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="region_{{$i}}" type="text" class="form-control" name="region_{{$i}}" value="{{ old('region_'.$i) == null ? $order[$i-1]['region'] : old('region_'.$i) }}">
          ...
          <div class="form-group{{ $errors->has('productor_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="productor_{{$i}}" type="text" class="form-control" name="productor_{{$i}}" value="{{ old('productor_'.$i) == null ? $order[$i-1]['productor'] : old('productor_'.$i) }}">
          ...
          <div class="form-group{{ $errors->has('file_'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                ...
                <input type="hidden" value="{{ old('file_id_'.$i) == null ? $order[$i-1]['wine_file_id'] : old('file_id_'.$i) }}" name="file_id_{{$i}}" id="file_id_{{$i}}">
        ...
        <div class="form-group">
            <div id="file_show_{{$i}}" class="col-md-offset-4 col-md-6">
                <div class="thumbnail hidden">
                    <img src="{{ $order[$i-1]['path'] == null ? 'http://placehold.it/5' : $order[$i-1]['path']}}" alt="">
                    <div class="caption">
                        <h4></h4>
                        <p></p>
          ...
          <div class="form-group{{ $errors->has('message'.$i) ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="message_{{$i}}" type="text" class="form-control" name="message_{{$i}}" value="{{ old('message_'.$i) == null ? $order[$i-1]['wines_message'] : old('message_'.$i) }}">
