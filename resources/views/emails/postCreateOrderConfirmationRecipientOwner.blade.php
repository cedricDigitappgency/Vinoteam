...
@section('content')
				...
				<p style='margin:0;padding:0;font-family:"Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif;margin-bottom:10px;font-weight:normal;font-size:14px;line-height:1.6'>
					Bonjour {{ $order->owner->firstname }} {{ $order->owner->lastname }}<br />
					C’est un jour de chance ! {{ $order->buyer->firstname }} {{ $order->buyer->lastname }} vous a acheté du vin !</p>
				<p style='margin:0;padding:0;font-family:"Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif;margin-bottom:10px;font-weight:normal;font-size:14px;line-height:1.6'>{{ $order->buyer->gender == 'M' ? 'Remboursez-le' : 'Remboursez-la' }} en cliquant sur le bouton « Rembourser » ci-dessous</p>
				<p style='margin:0;padding:0;font-family:"Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif;margin-bottom:10px;font-weight:normal;font-size:14px;line-height:1.6' align="center">
					Montant total de {{ $priceWtax = number_format($order->price*1, 2, '.', '') }}€<br />
