<!-- resources/views/houses/create_buyer.blade.php -->
...
<div id="container">
    ...
    <hr/>
    <p class="exemple"><i class="fa fa-glass" aria-hidden="true"></i> Ajout manuel d'un vin à la VinoCave de mes amis</p>
    <hr/>

    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form class="form" enctype="multipart/form-data" role="form" method="POST" action="{{ url('/houses/buyer/store') }}">
                    {{ csrf_field() }}

                    <div class="col-md-12">
                        <div class="form-group{{ $errors->has('owner_id') ? ' has-error' : '' }}">
                            <select id="owner_id" name="owner_id" class="form-control" >
                                <option>Chez qui ?</option>
                        ...
                        <a href="#" id="miniature" style="display: none;" data-toggle="modal" data-target="#choseWine">
                            <div class="col-md-12" style="border: #d4d4d4 2px;">
                                ...
                                <div class="col-md-7" style="padding-top:5px;">
                                    <div id="name_cru_mini" class="col-md-12"><div id="name_cru_mini_text"></div></div>
                                    <div id="year_mini" class="col-md-12"><div id="year_mini_text"></div></div>
                                    <div id="productor_mini" class="col-md-12"><div id="productor_mini_text"></div></div>
                                    <div id="region_mini" class="col-md-12"><div id="region_mini_text"></div></div>
                                </div>
                            </div>
                        </a>
                    </div>
