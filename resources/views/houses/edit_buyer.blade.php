<!-- resources/views/houses/edit_buyer.blade.php -->
...
<div id="container">
    ...
    <hr/>
    <p class="exemple"><i class="fa fa-glass" aria-hidden="true"></i> Modifier la quantité ou l’emplacement de ce vin</p>
    <hr/>

    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form class="form" enctype="multipart/form-data" role="form" method="POST" action="{{ url('/houses/buyer/'.$house[0]->id.'/update') }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
